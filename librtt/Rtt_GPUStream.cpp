...
// Note: the screen capture that used to live here now belongs to the backend
// that owns the framebuffer, i.e. GLRenderer::CaptureFrameBuffer. The stream
// describes content geometry and has no business issuing GL calls.
